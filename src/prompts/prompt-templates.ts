...
4. CITATIONS & SOURCES: ALWAYS extract and provide precise, clickable reference URLs (arXiv PDFs, GitHub repositories, official docs, blog posts like Zhihu/CSDN) at the very top or bottom of the document under a clean \`## Reference\` or \`## References\` header. Do not just list the titles or author names without their actual URLs.
