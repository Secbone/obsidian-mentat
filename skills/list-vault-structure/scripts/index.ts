// List Vault Structure Implementation
// Core logic for listing vault structure
...
export async function execute(
  ...
  try {
    ...
    console.error('[ListVaultStructure] Error:', error);
    return {
      success: false,
      error: (error as Error).message || 'Failed to list vault structure'
    };
  }
}
